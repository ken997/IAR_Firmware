...
void SWVTIME_ACCURACY_TEST(void);
void DEBUGPINCONTROL(GPIO_PinState STATE);
void countup();
void DEBUGVALUE(uint32_t value, uint8_t n);
...
void ACCalculationTask(void *argument)
{
  ...
  {       
	  ...
	  uint16_t DMA_STATUS = QUEUE_msg;
	  for (uint32_t CalculationNumber = 0; CalculationNumber < 5-1; CalculationNumber++){
