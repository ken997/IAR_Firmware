...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  if(hadc->Instance==((ADC_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x2200UL)))
  {
    ...
    hdma_adc3.Instance = ((DMA_Stream_TypeDef *) (((0x40000000UL + 0x00020000UL) + 0x6400UL) + 0x010UL));
    hdma_adc3.Init.Channel = 0x04000000U;
    hdma_adc3.Init.Direction = 0x00000000U;
    hdma_adc3.Init.PeriphInc = 0x00000000U;
    hdma_adc3.Init.MemInc = (0x1UL << (10U));
    hdma_adc3.Init.PeriphDataAlignment = (0x1UL << (11U));
    hdma_adc3.Init.MemDataAlignment = (0x1UL << (13U));
    hdma_adc3.Init.Mode = (0x1UL << (8U));
    hdma_adc3.Init.Priority = (0x3UL << (16U));
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  if(hadc->Instance==((ADC_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x2200UL)))
  {
    ...
    HAL_GPIO_DeInit(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1400UL)), ((uint16_t)0x0040U));
...
{
  if(htim_base->Instance==((TIM_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x0000UL)))
  {
