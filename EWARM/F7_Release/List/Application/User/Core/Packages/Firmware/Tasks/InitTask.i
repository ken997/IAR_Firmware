...
osThreadId_t TestTask_TaskHandle;
...
void init_tasks(){
  ...
  defaultTaskHandle = osThreadNew(StartDefaultTask, 0, &defaultTask_attributes);

   
  AC_CalculationTHandle = osThreadNew(ACCalculationTask, 0, &AC_CalculationT_attributes);

   
  TestTask_TaskHandle = osThreadNew(TestTask, 0, &TestTask_attributes);
