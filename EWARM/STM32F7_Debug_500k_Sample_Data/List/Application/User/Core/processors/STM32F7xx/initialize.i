...
{
    signed long long int _Ix = __iar_fp2bits64(_X);
    return ((_Ix << 1) >> (52 + 1)) + 1;
}
...
int initialize(void)
{
  ...
  ((DBGMCU_TypeDef *) 0xE0042000UL)->APB1FZ |= (0x1UL << (2U));
  ((DBGMCU_TypeDef *) 0xE0042000UL)->APB2FZ |= (0x1UL << (0U));
  ...
  HAL_ADC_Start_DMA(&hadc3, (uint32_t *) dmabuffer , 4000);
...
static void MX_ADC3_Init(void)
{
  ...
  hadc3.Init.ScanConvMode = ((uint32_t)0x00000000);
  ...
  hadc3.Init.ExternalTrigConvEdge = ((uint32_t)(0x3UL << (28U)));
  
  
  hadc3.Init.ExternalTrigConv = ((uint32_t)((0x8UL << (24U)) | (0x1UL << (24U))));
  ...
  sConfig.Channel = ((uint32_t)((0x02UL << (0U)) | (0x01UL << (0U))));
...
static void MX_TIM1_Init(void)
{
  ...
  htim1.Init.Period = ((16/8*170/2)*2-1);
  ...
  sMasterConfig.MasterOutputTrigger2 = (0x2UL << (20U));
...
{  
  GPIO_InitTypeDef GPIO_InitStruct = {0};
    ...
    do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB2ENR) |= ((0x1UL << (10U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB2ENR) & ((0x1UL << (10U)))); (void)tmpreg; } while(0);

    do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->AHB1ENR) |= ((0x1UL << (5U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->AHB1ENR) & ((0x1UL << (5U)))); (void)tmpreg; } while(0);
...
void HAL_TIM_PeriodElapsedCallback(TIM_HandleTypeDef *htim)
{
  ...
  if (htim->Instance == ((TIM_TypeDef *) (0x40000000UL + 0x0800UL))) {
    HAL_IncTick();
  }
}
