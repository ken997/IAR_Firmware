...
GPIO_TypeDef* DEBUG_PIN1_PORT = ((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0800UL));
uint16_t DEBUG_PIN1_NUMBER = ((uint16_t)0x0800U);
...
void SerialWireSend(uint32_t value, uint8_t StimulusPort){
  ...
  (*((volatile unsigned int *) (0xE0000000+4*StimulusPort))) = value;
}
