...
HAL_StatusTypeDef HAL_ADC_Start(ADC_HandleTypeDef* hadc)
{
  ...
  else
  {
    ...
    ((hadc->State) |= (((uint32_t)0x00000010U)));
    
     
    ((hadc->ErrorCode) |= (((uint32_t)0x01U)));
  }
...
HAL_StatusTypeDef HAL_ADC_ConfigChannel(ADC_HandleTypeDef* hadc, ADC_ChannelConfTypeDef* sConfig)
{
  ...
  if ((sConfig->Channel > ((uint32_t)((0x08UL << (0U)) | (0x01UL << (0U))))) && (sConfig->Channel != 0x80000000U))
  {
  ...
  if ((hadc->Instance == ((ADC_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x2000UL))) && (sConfig->Channel == 0x80000000U))
  {
     
    ((ADC_Common_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x2300UL))->CCR &= ~((0x1UL << (22U)) | (0x1UL << (23U)));
  }
